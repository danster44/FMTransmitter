...
HD_PWD='C:/Users/danny/Downloads/Projects/FMTransmitter/FMTransmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DDS_wrapper.tcl -notrace
