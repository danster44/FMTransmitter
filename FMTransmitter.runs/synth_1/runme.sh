...
HD_PWD='C:/Users/danny/Downloads/Projects/FMTransmitter/FMTransmitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DDS_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DDS_wrapper.tcl
