...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L xil_defaultlib -L blk_mem_gen_v8_4_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DDS xil_defaultlib.DDS xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  DDS -key {Behavioral:sim_1:Functional:DDS} -tclbatch cmd.tcl -protoinst "protoinst_files/DDS.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DDS.wdb xsim.dir)
